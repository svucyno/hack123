    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('farmer', 'Farmer'), ('customer', 'Customer')], default='customer', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purpose', models.CharField(choices=[('login', 'Login'), ('password_reset', 'Password Reset'), ('admin', 'Admin Login')], max_length=32)),
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['email', 'scope', 'requested_at'], name='accounts_ot_email_f764a0_idx')],
            },
        ),
    ]
